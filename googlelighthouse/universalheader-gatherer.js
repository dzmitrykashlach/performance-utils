...
class UniversalHeaderGatherer extends Gatherer {
  afterPass(options) {
    const driver = options.driver;
    return driver.evaluateAsync('window.enwikiMetrics')
      ...
      .then(enwikiMetrics => {
        if (!enwikiMetrics) {
          ...
          throw new Error('Unable to find enwikiMetrics metrics in page');
        }
        return enwikiMetrics;
...
module.exports = UniversalHeaderGatherer;
